...
const NotificationDrawer = ({ notificationdrawer, setNotificationDrawer }) => {
    return (
        <Drawer placement="right" width={"40%"} className='notification-drawer' closeIcon={false} open={notificationdrawer}>
            <div className='w-100'>
                <div className='d-flex justify-content-between align-items-center p-3 bg-light'>
                    <span className='fs-5 fw-semibold'>Notifications</span>
                    <CloseOutlined style={{ cursor: 'pointer' }} onClick={() => setNotificationDrawer(false)} />
                </div>
                        ...
                        <div className="w-100 bg-white p-0 m-0"
                            ...
                            <div className='w-100 p-4'>
                                <div className='w-100 d-flex gap-4 border-bottom pb-3'>
                                    <div className='border p-2 rounded-2'><ScanOutlined style={{ width: '25px' }} /></div>
