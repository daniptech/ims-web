                        ...
                        <div className='col-8'>
                            ...
                            <div className='row col-12'>
                                ...
                                <div className='col-5'>
                                    ...
                                    >
                                        <Radio.Group name="radiogroup" onChange={(e) => setTransactionType(e.target.value)}>
                            ...
                            <div className='row col-12'>
                                ...
                                <div className='col-10'>
                                    ...
                                    >
                                        <Radio.Group name="radiogroup" className='radio-container w-100 d-flex' onChange={(e) => setPriceListType(e.target.value)}>
                                            <Radio value='all_items' className='radio-item rounded-3'>
                                                <div className='d-flex flex-column'>
                                                    <span className='fw-medium'>All Items</span>
                                                    <span className='text-muted' style={{ fontSize: 12 }}>Mark up or mark down the rate of all items</span>
                                                </div>
                                            </Radio>
                                            <Radio value='individual_items' className='radio-item rounded-3'>
                                                <div className='d-flex flex-column'>
                                                    <span className='fw-medium'>Individual Items</span>
                                                    <span className='text-muted' style={{ fontSize: 12 }}>Customise the rate for each item individually</span>
                                                </div>
                                            </Radio>
                                        </Radio.Group>
                                    </Form.Item>
                                    ...
                                    <>
                                        <div className='row col-12'>
                                            ...
                                            <div className='col-5'>
                                                ...
                                                >
                                                    <Radio.Group name="radiogroup" className='radio-container w-100 d-flex' onChange={(e) => setPriceListType(e.target.value)}>
                                                        <Radio value='unit_price' className='radio-item rounded-3'>Unit Price</Radio>
                                                        <Radio value='volumn_item' className='radio-item rounded-3'>Volume Pricing</Radio>
                                                    </Radio.Group>
                                                </Form.Item>
                                            </div>
                                        </div>
                                        ...
                                        <div className='row col-12'>
                                            ...
                                            <div className='col-6'>
                                                <Form.Item
                                                    name='discount'
                                                >
                                                    <Checkbox onChange={(e) => setDiscount(e.target.checked)} >I want to include discount percentage for the items</Checkbox>
                                                </Form.Item>
                                            </div>
                                            {discount ? <span className='d-flex gap-2 align-items-center mt-0' ><FontAwesomeIcon icon={faCircleInfo} style={{ color: "#1162ee", }} />When a price list is applied, the discount percentage will be applied only if discount is enabled at the line-item level</span> : "   "}
                                        </div>
                            ...
                            <>
                                ...
                                <div>
                                    <div className='d-flex justify-content-between'>
                                        ...
                                        <span className='d-flex align-items-center gap-2'>Import Price List for Items<Switch height={10} /></span>
                                    </div>
                                </div>
                                <div className='mt-2'>
                                    <Table
