...
import { createCompositeItem } from '../../../controller/api/inventory/compositeServices';
...
const CreateAndEditCompositeItem = () => {
  ...
  const handleSubmit = async (val) => {
    ...
    if (params.id) {
      console.log('edit logic panding');
    } else {
      try {
                      ...
                      return (
                        <>
                          <tr className="" key={index}>
                            ...
                            <td style={{ width: '15%' }} className="border bg-white">
                              <span className="d-flex justify-content-end">{val.sellingPrice}</span>
                            </td>
                            <td style={{ width: '15%' }} className="border bg-white">
                                ...
                                <div className="d-flex gap-2">
                                  ...
                                  {val?.servicesDetail !== '' ? (
                                    ...
                                    <Dropdown
                                      trigger={'click'}
                                      menu={{
                                        items: associatedServicesDropDownData?.map((val, index) => {
                                          return {
                                            label: (
                                              <div className="row col-12 m-0 p-0">
                                                <div className="col-6 text-start">
