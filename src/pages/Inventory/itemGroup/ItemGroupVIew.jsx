        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
         ...
         {hasAccessFeature(accesslevel.write,moduleEnum.Inventory_item_groups)&&<div className="d-flex justify-content-center align-items-center gap-2 ">
            ...
            <Dropdown
              ...
              trigger="click"
            >
              <Button className="d-flex justify-content-center align-items-center bg-light">
                More <DownOutlined />
              </Button>
            </Dropdown>
          </div>}
          ...
          <div className="row col-12 lh-lg">
            <div className="col-md-6 col-lg-6 ">
              <div className="row col-12">
                <div className="col-4 text-muted fw-medium text-capitalize">Unit</div>
                <div className="col-2 text-muted fw-medium ">:</div>
                <div className="col-4">ad</div>
              </div>
            </div>
            <div className="col-md-6 col-lg-6 ">
              <div className="row col-12">
                <div className="col-4 text-muted fw-medium text-capitalize ">Manufacturer</div>
                <div className="col-2 text-muted fw-medium ">:</div>
                <div className="col-4">burger</div>
              </div>
            </div>
            <div className="row col-12">
              <div className="col-md-6 col-lg-6 ">
                <div className="row col-12">
                  <div className="col-4 text-muted fw-medium text-capitalize ">Brand</div>
                  <div className="col-2 text-muted fw-medium ">:</div>
                  <div className="col-4">branded</div>
                </div>
              </div>
            </div>
            <div className="row col-12">
              <div className="col-md-6 col-lg-6 d-flex">
                <div className="row col-12">
                  <div className="col-4 text-muted fw-medium text-capitalize ">color</div>
                  <div className="col-2 text-muted fw-medium ">:</div>
                  <div className="col-4">
                    <span
                      className="bg-info rounded-1 p-1 text-white fw-medium"
                      style={{ fontSize: '14px' }}
                    >
                      black
                    </span>
