...
import { ArrowLeftOutlined, CaretDownOutlined, CaretRightOutlined, DeleteOutlined, PlusCircleOutlined, PlusOutlined, QuestionCircleOutlined } from '@ant-design/icons';
import {
    Button,
    Checkbox,
    Divider,
    ...
    const columns = [
        ...
        },
        {
            title: () => {
                return (
                    <div className='d-flex flex-column'>
                        <span className=''>OPENING STOCK VALUE (RS.) <Tooltip
                            placement="rightTop"
        ...
        },
        {
            title: () => {
                return (
                    <div className='d-flex flex-column'>
                        <span className=''>COST PRICE (RS.) * <Tooltip
                            placement="rightTop"
        ...
        },
        {
            title: () => {
                return (
                    <div className='d-flex flex-column'>
                        <span className=''>SELLING PRICE (RS.) * <Tooltip
                            placement="rightTop"
                            title="Click here to apply the same price to all the items"
                        >
                            <QuestionCircleOutlined className="text-muted" />
        ...
        },
        {
            title: () => {
                return (
                    <span className=''>	REORDER POINT <Tooltip
                        placement="rightTop"
                    ...
                    <div>
                                ...
                                <div className='row col-12'>
                                    ...
                                    <div className='col-lg-4'>
                                        <div>
                                            ...
                                            <Form.Item
                                                name="attribute"
                                                className="d-flex m-0 form-item mt-2"
                                            >
                                                <Select
                                                    showSearch
                                    ...
                                    <div className='col-lg-5'>
                                        <div>
                                            ...
                                            <div className='d-flex justify-content-between align-items-center mt-2'>
                                                <Form.Item
                                                    name="options"
                                                    className="d-flex m-0 form-item" style={{ width: '90%' }}
                                                >
                                                    <Form.Item name="brand" className="d-flex m-0 form-item">
                                                        <Select
                                                            mode="multiple"
                        ...
                        <div className='row col-12 w-100 m-0 bg-light p-2'>
                            ...
                            <div className='col-6 text-end'>
                                ...
                                <Form.Item
                                    name='opening_stock_include'
                                    className="d-flex m-0 form-item"
                                >
                                    <Checkbox>
                                        <div className='d-flex align-items-center gap-2'>
                                            <span>Include Opening Stock</span>
                                            <Tooltip placement="rightTop" title="Opening stock will be added for the item">
                                                <QuestionCircleOutlined className="text-muted" />
                                            </Tooltip>
                                        </div>
                                    </Checkbox>
                        ...
                        <div className='row col-12 w-100 m-0 p-2 mb-5'>
                            <Button type="link" className='fs-6 d-flex p-0 align-items-center' onClick={() => setConfigureAccount(!configureAccount)} > {configureAccount ? <CaretDownOutlined /> : <CaretRightOutlined />} Configure Accounts
                                <Tooltip
                                    placement="rightTop"
