          ...
          <>
            <div className="d-flex gap-2 align-items-center">
              ...
              <span className="text-muted fs-6">
                {selectedRows?.selectedRows?.length} Inventory Adjustments Selected
              </span>
            </div>
            ...
            <div className="d-flex gap-2 align-items-center">
              ...
              >
                <Button className="d-flex align-items-center justify-content-center">
                  {' '}
                  Type: Sales Order <CaretDownOutlined />
                </Button>
              </Dropdown>
              <Dropdown
                menu={{
              ...
              >
                <Button className="d-flex align-items-center justify-content-center">
                  Period: Sales Order <CaretDownOutlined />
                </Button>
              </Dropdown>
            </div>
            <div
      ...
      <div className=" p-3">
        <Table
          ...
          onRow={(record) => ({
            onClick: () =>
              navigate(
                reverse(routes.inventory.inventoryAdjustments.view, {
                  id: record.key
                })
              )
          })}
