        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 ">
            <Button
              ...
              onClick={() =>
                navigate(reverse(routes.sales.paymentReceived.edit, { id: params.id }))
              }
            >
              <EditOutlined />
            </Button>
      ...
      >
        <div className=" w-100 pdf-box p-5 rounded-1">
          ...
          <div className="text-center w-100">
            <span className="border-bottom fs-3">PAYMENT RECEIPT</span>
          </div>
          <div className="w-100 row col-12">
            <div className="col-8">
              <div className="row col-12 lh-lg">
                ...
                <div className="col-8 border-bottom fw-semibold">
                  Indian Rupee Eighteen Thousand Only
                </div>
              </div>
            </div>
            <div className="col-4 d-flex justify-content-center">
              <div
                className="d-flex flex-column justify-content-center align-items-center p-4 bg-success text-white"
          ...
          <div className="text-end w-100">
            <span className="text-muted">Over payment: Rs.18,000.00</span>
          </div>
        </div>
        <div className="mt-4">
