            ...
            <div className='w-100 border-bottom'>
                <div className='d-flex justify-content-between align-items-center p-4 px-3'>
                    ...
                    <div className='d-flex justify-content-center align-items-center gap-2 '>
                        <Button className='d-flex justify-content-center align-items-center p-2 fs-5 bg-light' onClick={() => navigate(reverse(routes.sales.creditNotes.edit, { id: params.id }))}><EditOutlined /></Button>
                    ...
                    <div className='mt-1'>
                        ...
                        <div className='mt-5'>
                            <Table columns={[
                                ...
                                { title: 'QTY', dataIndex: 'order', key: 'order', render: (text, record) => <div className='d-flex flex-column'><span>1</span><span>g</span></div> },
