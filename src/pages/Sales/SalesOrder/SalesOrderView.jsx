        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 ">
            <Button
              ...
              onClick={() => navigate(reverse(routes.sales.salesOrder.edit, { id: params.id }))}
            >
              <EditOutlined />
            </Button>
                ...
                <div>
                  ...
                  >
                    <div className="row col-12">
                      ...
                      <div className="col-9">
                        <span className="bg-primary bg-opacity-75 p-1 rounded-2">CLOSED</span>
                      </div>
                    </div>
                    <div className="row col-12">
                      ...
                      <div className="col-9">
                        {' '}
                        <div className="text-success">Invoiced</div>
                      </div>
                    </div>
                    <div className="row col-12">
                      ...
                      <div className="col-9">
                        {' '}
                        <div className="text-success">Unpaid</div>
                      </div>
                    </div>
                    <div className="row col-12">
