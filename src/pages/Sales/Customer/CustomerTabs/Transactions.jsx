  ...
  return (
    ...
    />
     <Collapse className='mt-4'
      items={[{ key: '1', label: ' Invoices', children: <Table columns={columns} dataSource={data}/> }]}
    />
    <Collapse className='mt-4' items={[{ key: '1', label: 'Customer Payments', children:<div className='d-flex align-item-center justify-content-center'>
      ...
      <Collapse className='mt-4' 
        items={[{ key: '1', label: 'Sales Orders', 
     ...
     />
     <Collapse className='mt-4' items={[{ key: '1', label: ' Packages', 
     ...
     <Collapse className='mt-4' 
        items={[{ key: '1', label: 'Delivery Challans', 
          children: <Table columns={[
            { title: 'Delivery Challans', dataIndex: 'deliveryChallans',key:'deliveryChallans'},
            { title: 'REFERENCE NUMBER', dataIndex: 'referenceNumber',key:'referenceNumber'},
            { title: 'DATE', dataIndex: 'date',key:'date'},
            { title: 'AMOUNT', dataIndex: 'amount',key:'amount'},
            { title: 'STATUS', dataIndex: 'status',key:'status'},
     ...
     <Collapse className='mt-4' items={[ { key: '1', label: 'Bills',
     children: <div className='d-flex align-item-center justify-content-center'>
                 <p class="mb-0">There are no Bills</p>
                </div>}]}/>
     <Collapse className='mt-4' items={[{ key: '1', label: 'Credit Notes', 
    children: <div className='d-flex align-item-center justify-content-center'>
