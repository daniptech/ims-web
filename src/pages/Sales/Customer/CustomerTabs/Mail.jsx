...
export const Mail = () => {
  return (
    <div className=" border border-1 rounded-2 mt-4">
        ...
        <div className="p-3 d-flex justify-content-between">
          <div className=" d-flex gap-2">
            ...
            <div className="d-flex flex-column">
              <span>
                To <span className="fw-medium">demo1@yopmail.com</span>
              </span>
              <span>
                Sales Order Notification - Sales Order from Personal (Sales Order #: SO-00003)
              </span>
            </div>
          </div>
