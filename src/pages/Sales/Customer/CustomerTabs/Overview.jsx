...
export const Overview = () => {
      ...
      <div className="d-flex mt-3">
        ...
        {editMoreDetails ? (
          ...
          >
            ...
            <EditOutlined
              onClick={() => setEditMoreDetails(!editMoreDetails)}
  ...
  let data = [
    { date: '20/07/2023 05:10 PM', title: '', text: 'rtgrt by veeresh' },
    {
    ...
    <div className=" container w-100 h-100 m-0 p-0">
      <div class="row">
        <div class="col-4 bg-light h-100 p-4">
                ...
                <div class="d-flex text-black">
                  ...
                  <div class="flex-grow-1 ms-3">
                    ...
                    <div class="d-flex">
                      ...
                      <h8 class="me-1" style={{ color: '#2b2a2a' }}>
                        123456789899
                      </h8>
                    </div>
                    <div class="d-flex">
          ...
          <div
            class="border-bottom mt-1 pb-1 d-flex "
          ...
          {otherDetails && (
            <div>
              ...
              <div className="d-flex mt-2">
                ...
                >
                  <p
                    className="rounded-circle bg-danger mt-3"
                    style={{ width: '4px', height: '4px', marginRight: '2px' }}
                  />
          ...
          <div class="border-bottom mt-1 pb-1 d-flex " onClick={() => setContactUs(!contactUs)}>
            ...
            <PlusCircleOutlined
              style={{ fontSize: '20px', color: '#1677ff', marginRight: '10px' }}
            />
              ...
              >
                <div className="d-flex mt-2">
                  ...
                  <p className="text-justify">
                    Customer Portal allows your customers to keep track of all the transactions
                    between them and your business.<Button type="link">Learn More</Button>
                  </p>
                </div>
          ...
          {recordInfo && (
            <>
              <div className="mt-2">
                <h7 className="me-3" style={{ color: '#b1b1b1' }}>
                  Customer ID
                </h7>
                <h7 style={{ color: '#000' }}>1367875000000017123</h7>
              </div>
              <div>
                <h7 className="me-4" style={{ color: '#b1b1b1' }}>
                  Created on
                </h7>
        ...
        <div className="col">
          <div className="mt-3 ml-4">
            ...
            <h4 className="mt-4" style={{ color: '#000' }}>
              Receivables
            </h4>
            ...
            {data?.map((items, i) => (
              <div key={i} className={i === 0 ? 'd-flex mt-5' : 'd-flex'}>
                ...
                />
                <div
                  className="border border-1 rounded-circle p-1 d-flex justify-content-center mt-4"
                  style={{
                    width: '25px',
                    height: '25px',
                    marginLeft: '-12px',
