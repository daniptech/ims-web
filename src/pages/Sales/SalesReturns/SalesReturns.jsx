  ...
  return (
    <div className="w-100 h-100 justify-content-center align-items-center bg-light">
      <div className="p-3 text-center mt-4">
        <h4>Sales Returns</h4>
        <p>
          Process your product returns in a few simple steps and get your inventory automatically
          sorted out.
          <br />
          Start creating sales returns from sales orders
        </p>
        <br />
        <Button type="primary" onClick={() => navigate(routes.sales.salesOrder.self)}>
          GO TO SALES ORDER
        </Button>
      </div>
      <Divider />
