                    ...
                    >
                        <div className='row col-12 m-0 p-0'>
                            ...
                            <div className='col-12'>
                                ...
                                >
                                    <Input placeholder="Phone Number" minLength={10} maxLength={10}  addonBefore={selectBefore} onKeyPress={(e)=>enterOnlyNumber(e)} />
                                </Form.Item>
                            </div>
                            <div className='col-12'>
                                <Form.Item
                        ...
                        <div className="text-center text-muted">
                            ...
                            <span className="text-primary navigate-auth" onClick={()=>navigate(routes.login.self)}>
                                Login.
                            </span>
                        </div>
                    </Form>
