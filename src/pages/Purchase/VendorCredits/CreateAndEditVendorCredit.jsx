import { ArrowLeftOutlined, DownOutlined, SearchOutlined, UploadOutlined } from '@ant-design/icons';
                ...
                <table className="w-100 custom-table-create">
                  <thead className="w-100">
                    <tr className="border-bottom border-top">
                      <th style={{ width: '39%' }} className="border-end">
                        ITEM DETAILS
                      </th>
                      <th style={{ width: '14%' }} className="border-end text-end">
                        ACCOUNT
                      </th>
                      <th style={{ width: '14%' }} className="border-end text-end">
                        QUANTITY
                  ...
                  <tbody className="w-100">
                    <tr className="border-bottom">
                      <td style={{ width: '39%' }} className="border-end">
                      ...
                      <td style={{ width: '14%' }} className="border-end">
                      ...
                      <td style={{ width: '14%' }} className="text-end">
                        0.00
                      </td>
