        ...
        <div className="w-100">
            <div className="w-100 bg-white p-3 border-bottom d-flex align-items-center justify-content-between ">
                <div className="d-flex align-items-center gap-4 fs-5">
                    ...
                    <span className="fw-medium">{params.id ? 'Edit' : 'New'} Vendor Credits</span>
                </div>
                <div className="d-flex align-items-center gap-4 fs-5">
                        ...
                        <div className="row col-12 p-4 m-0">
                            <div className="col-6 d-flex flex-column gap-3">
                                ...
                                <div className="row col-12 d-flex  align-items-center">
                                    ...
                                    <div className="col-6">
                                        <Form.Item name="credit_note" className="d-flex m-0 form-item">
                                            <Input />
                                        </Form.Item>
                                    </div>
                                </div>
                                ...
                                <table className='w-100 custom-table-create'>
                                    <thead className='w-100'>
                                        <tr className='border-bottom border-top'>
                                            <th style={{ width: '39%' }} className='border-end' >ITEM DETAILS</th>
                                            <th style={{ width: '14%' }} className='border-end text-end' >ACCOUNT</th>
                                            <th style={{ width: '14%' }} className='border-end text-end' >QUANTITY</th>
                                            <th style={{ width: '14%' }} className='border-end text-end' >RATE</th>
                                            <th style={{ width: '14%' }} className=' text-end'>AMOUNT</th>
                                            <th style={{ width: '5%' }} className='text-end'></th>
                                        </tr>
                                    </thead>
                                    <tbody className='w-100'>
                                        <tr className='border-bottom'>
                                            <td style={{ width: '39%' }} className='border-end' ><div className='d-flex gap-2'>
                                            ...
                                            <td style={{ width: '14%' }} className='border-end' ><Select className='w-100' options={[]} /></td>
                                            <td style={{ width: '14%' }} className='border-end' ><Input className='input-field' placeholder='0.00' /></td>
                                            <td style={{ width: '14%' }} className='border-end' ><Input className='input-field' placeholder='0.00' /></td>
                                            <td style={{ width: '14%' }} className='text-end' >0.00</td>
...
export default CreateAndEditVendorCredit
