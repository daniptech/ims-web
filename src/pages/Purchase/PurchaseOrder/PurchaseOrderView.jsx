                        ...
                        items={[
                            {
                                ...
                                children: <Table columns={[
                                    { title: 'Purchase Receive', dataIndex: 'purchase_receive', key: 'purchase_receive' },
                                ...
                                <div>
                                    ...
                                    <div className='p-2' style={{ borderLeftColor: 'orange', borderLeftWidth: '3px', borderLeftStyle: 'solid' }}>
                                        <div className='row col-12'>
                                            ...
                                            <div className='col-9'><span className='bg-primary bg-opacity-75 p-1 rounded-2'>ISSUED</span></div>
