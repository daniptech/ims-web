    ...
    const items = [
        {
            key: '1',
            label: 'ADDRESS',
            children: <div className='w-100 d-flex flex-column gap-3'>
                <div className='d-flex flex-column'>
                    <strong>Billing Address</strong>
                    <span className='text-muted'>No Billing Address - <span className='view-btn text-primary'>Add new address</span></span>
                </div>
                <div className='d-flex flex-column'>
                    <strong>Shipping Address</strong>
                    <span className='text-muted'>No Shipping Address - <span className='view-btn text-primary'>Add new address</span></span>
                </div>
                        ...
                        {otherDetail.defaultCurrency === 'edit'
                            ...
                            <div className='d-flex justify-content-between gap-1'>
                                <Select
                                    ...
                                    options={[]}
                                />
                                <div className='rounded-2 d-flex'><div className='bg-success rounded-start-2 d-flex justify-content-center align-items-center p-2' ><CheckOutlined /></div><div className=' bg-danger rounded-end-2  d-flex justify-content-center align-items-center p-2' onClick={() => setOtherDetail({ defaultCurrency: 'view' })}><CloseOutlined /></div></div>
                            </div>
                            :

                            <div className='d-flex justify-content-between currency-value p-1 rounded-1 align-items-center text-muted'>INR  <EditOutlined className='other-detail-edit-icon' onClick={() => setOtherDetail({ defaultCurrency: 'edit' })} /></div>
                        }
                    </div>
                ...
                <div className=' d-flex justify-content-between'>
                    <div className='d-flex gap-3'>
                        ...
                        <div className='d-flex flex-column'>
                            ...
                            <span>developer</span>
                            <span>IT</span>
                            <span className='d-flex align-items-center gap-2'><PhoneOutlined rotate={90} /> 32665959849</span>
                            <span className='d-flex align-items-center gap-2'><MobileOutlined /> 32665959849</span>
                            <span className='d-flex align-items-center gap-2'><SkypeFilled style={{ color: "#2a4d89", }} /> live:cid20y92ybskf9t</span>
                        </div>
                    </div>
                    <div>
                        <Dropdown
        ...
        },
        {
            ...
            children: <div className='w-100'>
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    <div className='d-flex gap-3 align-items-center'><span className='text-primary'>Edit</span><DeleteOutlined /></div>
                </div>
            </div>,
            extra: <PlusCircleOutlined className='text-primary' />
        },
            ...
            <div className='col-4 bg-light h-100 p-4'>
                ...
                <div className='d-flex gap-3'>
                    ...
                    <div className='d-flex flex-column'>
                        ...
                        <span className='d-flex align-items-center gap-2'><MobileOutlined /> 32665959849</span>
                        <span className='d-flex align-items-center gap-2 text-primary' style={{ fontSize: '12px' }}><span className='view-btn'>Edit</span><span className='view-btn'>Send Email</span> <span className='view-btn'>Delete</span></span>
                    </div>
                </div>
                <Collapse className='border-0 mt-5 custom-collapse' items={items} defaultActiveKey={['1', '2', '3', '4', '5']} />
            </div>
            <div className='col-8 p-0 m-0'>
                <div className='d-flex gap-3 p-4' style={{ background: '#f7faff' }} >
                    ...
                    <div className='pt-4' >
                        ...
                        <p className='text-muted'>Your vendor has been added. Create a purchase order or record a bill for the items you buy from your vendor.</p>
                ...
                <div className='p-4'>
                    ...
                    <div className='w-100 bg-light mt-2 p-3 d-flex gap-3'>
                        <span className='border-end p-2 fw-medium'>Items to be received: <span className='text-danger'>0</span></span>
                        <span className='p-2 fw-medium'>Total items ordered: <span className='text-danger'>0</span></span>
                    </div>
                    <div>
                        {data?.map((items, i) =>
