        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 ">
            <Button
              ...
              onClick={() => navigate(reverse(routes.purchase.paymentMode.edit, { id: params.id }))}
            >
              <EditOutlined />
            </Button>
      ...
      >
        <div className=" w-100 pdf-box p-5 rounded-1">
          ...
          <div className="text-center w-100">
            <span className="border-bottom fs-3">PAYMENTS MADE</span>
          </div>
            ...
            <div className="col-8">
              <div className="row col-12 lh-lg">
                ...
                <div className="col-8 border-bottom fw-semibold">
                  Indian Rupee Two Thousand Only
                </div>
              </div>
            </div>
          ...
          <div className="text-end w-100">
            <span className="text-muted">Over payment: Rs.2,000.00</span>
          </div>
        </div>
        <div className="mt-4">
