        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 ">
            <Button
              ...
              onClick={() =>
                navigate(reverse(routes.purchase.purchaseReceives.edit, { id: params.id }))
              }
            >
              <EditOutlined />
            </Button>
            ...
            <div className="row col-12">
              <div className="col-6 d-flex flex-column gap-3">
                ...
                <div className="row col-12 lh-lg">
                  ...
                  <div className="col-8">
                    {' '}
                    <span className="bg-success bg-opacity-75 p-1 rounded-2">RECEIVED</span>
                  </div>
                </div>
              </div>
            </div>
                        ...
                        <div className="w-100 ">
                          <div className="d-flex gap-5">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <span className="text-muted">SKU:{record.sku}</span>
                            </div>
                          </div>
                        </div>
                      );
