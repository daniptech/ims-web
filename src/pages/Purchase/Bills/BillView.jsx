        ...
        <div className="d-flex justify-content-between align-items-center p-4 px-3">
          ...
          <div className="d-flex justify-content-center align-items-center gap-2 ">
            <Button
              ...
              onClick={() => navigate(reverse(routes.purchase.bills.edit, { id: params.id }))}
            >
              <EditOutlined />
            </Button>
            <Dropdown
            ...
            <Button className="d-flex justify-content-center align-items-center gap-2">
              <FontAwesomeIcon icon={faPencil} /> Convert to Open
            </Button>
            <Dropdown
              trigger="click"
              menu={{
          ...
          <div className="border rounded-2 p-4 purchase-order-card">
            <div className="d-flex align-items-center gap-2 ">
              ...
              <span className="text-muted">
                Open Purchase Orders: <span className="text-dark fw-medium">1</span>
              </span>
            ...
            <div className="row col-12">
              <div className="col-6 d-flex flex-column gap-3">
                <div className="lh-lg">
                  ...
                  <div>
                    <span className=" p-1 rounded-1 text-white" style={{ backgroundColor: 'gray' }}>
                      ISSUED
                    </span>
                  </div>
                </div>
            ...
            <div className="row col-12 ">
              ...
              <div className="col-6 text-end d-flex flex-column gap-3">
                ...
                <div className="row col-12">
                  ...
                  <div className="col-6 text-muted">(-)Rs.0.00</div>
                </div>
