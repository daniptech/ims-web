                ...
                <Tabs defaultActiveKey="2" className="upload-document w-100">
                    <TabPane tab={<h6 className='m-0'>Uploaded Documents</h6>} className="" key="1">
                        <div className="w-100"
                            ...
                            <div className='w-100 d-flex justify-content-center align-items-center' style={{ minHeight: "40vh" }}>
                                <div className='w-50'>
                                    <Dragger {...draggerProps}>
                                        <div className='d-flex flex-column lh-lg'>
                                            <div className='mb-3'>
                                                <Image src={Images.uploadImage} alt='' style={{ width: '150px' }} preview={false} />
                                            </div>
