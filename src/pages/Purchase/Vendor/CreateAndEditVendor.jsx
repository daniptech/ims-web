...
import {
  ...
  getSingleVendor,
  updateVendor
} from '../../../controller/api/purchase/vendorServices';
              ...
              <div className="p-4">
                <Tabs defaultActiveKey="1">
                  ...
                  <TabPane tab="Bank Details" className="" key="4">
                    {params?.id ? (
                      <div className="w-100 text-center text-muted fw-semibold">
                        At the moment, you can add or edit the bank details only from the Contact
                        Overview page.
                      </div>
                    ) : (
